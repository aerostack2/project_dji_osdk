...
Please refer to https://aerostack2.github.io/_02_examples/dji/project_dji_osdk/index.html for more information.

## Installation

You need to clone and build [as2_platform_dji_osdk](https://github.com/aerostack2/as2_platform_dji_osdk),
refer to https://aerostack2.github.io/_03_aerial_platforms/_dji/index.html for more information.

To install this project, clone the repository:

```bash
git clone https://github.com/aerostack2/project_dji_osdk.git
```
...
Also, you need to configure *config/UserConfig.txt* file before launch the nodes.
